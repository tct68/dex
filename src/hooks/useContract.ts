...
import { abi as XBRDX_ABI } from 'abis/BeradexStaking.json'
...
export function useBeradexStaking() {
  return useContract<BeradexStaking>(BERADEX_STAKING_ADDRESS, XBRDX_ABI, true)
}
