...
export const AssetsContainer = styled(Column)`
  ...
  border: 1px solid rgba(118, 110, 0, 0.7);
  box-shadow: 0 0 5px rgba(255, 202, 0, 0.1), 0 0 7px rgba(39, 210, 234, 0.3);
  border-radius: 8px;
  margin-bottom: 50px;
  ${Glow}
`
...
export const AssetRow = styled(Link)`
  ...
  //box-shadow: 0 0 5px rgba(255, 202, 0, 0.1), 0 0 7px rgba(255, 202, 0, 0.1);
  :hover,
  :focus {
    ...
    background: linear-gradient(
      264deg,
      rgba(16, 16, 18, 0.1) 0%,
      rgba(255, 202, 0, 0.05) 25%,
      rgba(16, 16, 18, 0.1) 50%,
      rgba(255, 202, 0, 0.05) 75%,
